...
class DataAugmentationConfig(BaseModel):
    ...
    contrast_stretching: Optional[Tuple[float, float, float]] = Field(None, description="Normalize contrast using min-max scaling.")
    histogram_equalization: Optional[float] = Field(None, description="Apply histogram equalization.")

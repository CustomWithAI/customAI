...
const UploadProgress = () => {
	...
	const handleCancel = (id: string, abortController: AbortController) => {
		abortController.abort();
		cancelUpload(id);
	};
	if (uploads.length === 0) return null;
	return (
		<div className="fixed bottom-4 right-4 max-sm:w-screen z-50 bg-white border border-gray-200 rounded-lg p-6 pt-5 shadow-md">
						...
						({
							...
							>
								...
								<div className="mr-4 -mt-0.5 flex-1 max-sm:flex-col">
									...
									<Subtle className={cn("Content-nowrap text-gray-400")}>
								...
								<div className="my-auto flex flex-1 items-center justify-end">
									...
									{completed ? (
										...
										<Button
											...
											onClick={() => handleCancel(id, abortController)}
										>
											<X className="h-5 w-5" />
										</Button>
									)}

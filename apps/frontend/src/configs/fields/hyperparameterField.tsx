			...
			options: {
				...
				list: {
					"object detection": [
						...
						{ label: "yolov11s.pt", value: "yolov11s.pt" },
						{ label: "yolov11m.pt", value: "yolov11m.pt" },
						{ label: "yolov11l.pt", value: "yolov11l.pt" },
					],
					segmentation: [
						...
						{ label: "yolov11s-seg.pt", value: "yolov11s-seg.pt" },
						{ label: "yolov11m-seg.pt", value: "yolov11m-seg.pt" },
						{ label: "yolov11l-seg.pt", value: "yolov11l-seg.pt" },
					],
				},
			},
		},

	...
	return (
		<div className="space-y-4">
			<button
				onClick={() => setOpen((n) => !n)}
				type="button"
				className="hover:bg-zinc-50 border border-gray-200 px-3 py-2 -my-2 rounded-sm flex gap-x-3"
			>
			...
			{open && (
				<pre
					className={cn(
						"bg-gray-100 p-4 rounded-md mt-4 text-sm font-mono overflow-x-auto",
						className,
					)}
				>
					<code>{children}</code>
